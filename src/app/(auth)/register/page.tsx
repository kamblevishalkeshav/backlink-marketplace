...
export default function Register() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Successful registration would redirect to dashboard
      ...
      <div className="w-full md:w-1/2 bg-white p-8 flex items-center justify-center">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2 text-center">Sign up to get started with our platform</p>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link href="/login" className="font-medium text-[#2ac37a] hover:text-[#2ac37a]/90">
              Sign in
            </Link>
          </div>
