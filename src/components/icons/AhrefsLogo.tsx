...
interface AhrefsLogoProps {
  className?: string;
  width?: number;
  height?: number;
}

const AhrefsLogo: React.FC<AhrefsLogoProps> = ({ 
  className = "", 
  width = 24, 
  height = 24 
}) => {
  return (
    ...
    >
      <path 
        d="M80,213h44.3v12.4l-16.7,1.3c-26.9,2-35.3,9.1-35.3,29.1v4c0,14.6,10.2,23.4,26,23.4c12.4,0,19.6-2.9,28.4-11.9
        h1.5v9.5h17.8v-87.3H80V213z M124.3,255.1c-5.5,5.5-13.7,9.1-20.5,9.1c-7.3,0-10.4-2.7-10.2-8.8c0.2-8.4,3.3-10.4,17.4-11.7
        l13.4-1.3V255.1z"
        fill="#F18618"
      />
      <path 
        d="M183.2,193.6h34.2v17.8h18.7v69.5h-21.8v-67.7h-31.1v67.7h-21.8V167.4h21.8V193.6z M501.6,228.8l-13.2-1.3
