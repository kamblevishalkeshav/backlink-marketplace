...
interface SemrushLogoProps {
  className?: string;
  width?: number;
  height?: number;
}

const SemrushLogo: React.FC<SemrushLogoProps> = ({ 
  className = "", 
  width = 28, 
  height = 28 
}) => {
  return (
    ...
    >
      ...
      <path fill="#FF642D" d="M60.4,68.8c0,0.8-0.4,0.9-1.4,0.9c-1.1,0-1.3-0.2-1.4-1c-0.2-2.1-1.6-3.9-4-4c-0.7-0.1-0.9-0.3-0.9-1.3
